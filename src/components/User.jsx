...
const User = ({sportsEventsRef, usersRef, userId, setIsAdmin, setUserId, setIsLoggedIn, areasRef, citiesRef, sportsRef}) => {
	...
	useEffect(() => {
		async function getSports() {
            ...
            let optionsArray = allSportsArray.filter((el) => {
				// console.log(el.name)
		...
		return (
			...
			<div className="txt-3xl">
				...
				<div className="flex justify-center p-4">
					...
					<div onClick={() => setShowPreferences(true)} className="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-1/6 sm:w-1/6 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Preferences</div>
				</div>
			</div>
			{showPreferences && 
				<div className="mb-5">
